...
IR_files = sorted(get_img_file(r"./MSRS_RoadScene_train/ir"))
VIS_files   = sorted(get_img_file(r"./MSRS_RoadScene_train/vi"))

assert len(IR_files) == len(VIS_files)
h5f = h5py.File(os.path.join('./MSRS_RoadScene_train',
...
h5f.close()
print(f"Total number of patches: {train_num}") 

with h5py.File(os.path.join('./MSRS_RoadScene_train',
